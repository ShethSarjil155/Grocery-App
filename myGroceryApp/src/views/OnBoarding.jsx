    ...
    <View style={styles.container}>
      <View style={styles.contentBox}>
        <Image
          ...
          source={meta[metaIndex || 0].image}
        />
        <Text style={styles.title}>{meta[metaIndex || 0].title}</Text>
        <Text style={styles.subtitle}>{meta[metaIndex || 0].subtitle}</Text>
      </View>
      <TouchableOpacity onPress={onPress} style={styles.button}>
        <FontAwesome5 size={24} name="chevron-right" color="#fff" />
      </TouchableOpacity>
    </View>
  );
}
